...
class DCompany {
    ...
    string comp_ceo;
		...
		public:
		    DCompanyb(int id, string name, int staff_quantity, int revenue, int import_raw_diamonds, int export_diamonds, string ceo) 
			{
		        comp_id = id;
		        comp_name = name;
...
int main() {
    ...
    for (int i = 0; i < n; i++) 
	{
        ...
        dc[i].DCompanyb(id, name, staff_quantity, revenue, import_raw_diamonds, export_diamonds, ceo);
        dc[i].display() ;
    }
